...
4. Reinicia NinjaTrader (o desactiva y activa el addon). En *Tools → Output* debe aparecer
   `[TradePilotX] Bridge online. master=... (GET_ACCOUNTS_ALL disponible)`.
...
La cuenta maestra se sigue definiendo en `Documents\NinjaTrader 8\TradePilotX\config.json` (`MasterAccount`).
