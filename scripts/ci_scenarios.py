...
api("/risk/limits", "PUT", {"account_id": "Sim102", "max_daily_loss": 500, "max_position_size": 3, "trading_halted": False})
...
check("auditoría completa", {"REPLICATED", "FOLLOWER_FILL", "DESYNC", "SYNC_ORDER", "RESYNC", "DAILY_LOSS_LIMIT", "FLATTEN", "FLATTENED"} <= types, ",".join(sorted(types)))
