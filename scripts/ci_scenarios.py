...
check("auditoría completa", {"REPLICATED", "FOLLOWER_FILL", "DESYNC", "SYNC_ORDER", "RESYNC", "DAILY_LOSS_LIMIT", "DAILY_PROFIT_TARGET", "FLATTEN", "FLATTENED"} <= types, ",".join(sorted(types)))
