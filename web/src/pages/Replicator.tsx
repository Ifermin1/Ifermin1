...
export function Replicator() {
  ...
  const feed = audit.filter((a) => ["MASTER_RECEIVED", "REPLICATED", "BLOCKED", "SKIPPED", "ERROR", "FOLLOWER_FILL", "FOLLOWER_REJECTED", "NO_RULE", "ACCOUNT_FILL"].includes(a.event_type)).slice(0, 25);
