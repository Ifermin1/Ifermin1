...
| `FOLLOWER_FILL … (maestro 29459.0, +1.0, 176 ms; en bróker 90 ms)` | Copia ejecutada. El primer tiempo es lo que tardó el engine en enterarse (incluye la cola de mensajes); *en bróker* es el tiempo real entre el fill de la maestra y el de la seguidora según el reloj de NinjaTrader. | Si *en bróker* pasa de ~300 ms con el addon 2.5, revisa la conexión del bróker de esa cuenta. |
